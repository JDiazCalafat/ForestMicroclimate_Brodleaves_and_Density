...
```{r}
tree.data.plot$site_label <- ifelse(tree.data.plot$site == "Arville", "B (49° N)", ifelse(tree.data.plot$site == "Hochwald", "G (50° N)", ifelse(tree.data.plot$site == "Vivarp", "SS (56° N)", ifelse(tree.data.plot$site == "Siljan", "MS (60° N)", "NS (64° N)"))))
...
# filter(!(site %in% "Arville")) %>%
 ...
 size = 2.5) +
  scale_shape_manual(name = "Site",
                     ...
                     limits=c("NS (64° N)", "MS (60° N)", "SS (56° N)", "G (50° N)", "B (49° N)")) +
