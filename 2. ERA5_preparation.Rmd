...
snow.nc <- snow.nc[[which(getZ(snow.nc) >= as.Date("2019-09-01") & getZ(snow.nc) <= as.Date("2021-07-03"))]]

prec.nc <- prec.nc[[which(getZ(prec.nc) >= as.Date("2019-09-01") & getZ(prec.nc) <= as.Date("2021-07-03"))]]
```
