...
```{r}
# basal area
model.soil.jan.ba.all <- gamm4(soil_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.s.jan)

summary(model.soil.jan.ba.all$gam)
AIC(model.soil.jan.ba.all$mer)

#canopy openness
model.soil.jan.co.all <- gamm4(soil_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.s.jan)
...
```{r}
# basal area
model.soil.jul.ba.all <- gamm4(soil_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.s.jul)

summary(model.soil.jul.ba.all$gam)
AIC(model.soil.jul.ba.all$mer)

# canopy openness
model.soil.jul.co.all <- gamm4(soil_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.s.jul)
...
```{r}
# basal area
model.minair.jan.ba.all <- gamm4(min_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)

summary(model.minair.jan.ba.all$gam)
AIC(model.minair.jan.ba.all$mer)

# canopy openness
model.minair.jan.co.all <- gamm4(min_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)
...
```{r}
# basal area
model.meanair.jan.ba.all <- gamm4(air_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)

summary(model.meanair.jan.ba.all$gam)
AIC(model.meanair.jan.ba.all$mer)

# Snow (0.43) and prev_av_prec (0.27) not significant. Let's first remove snow:

model.meanair.jan.ba.nosnow <- gamm4(air_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)

summary(model.meanair.jan.ba.nosnow$gam)
AIC(model.meanair.jan.ba.nosnow$mer)

# Prev_av_prec is not significant (0.1). Let's remove it:

model.meanair.jan.ba.nosnowprec <- gamm4(air_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + prev_av_temp, random = ~ (1|site:Plot), data = tree.temp.a.jan)

summary(model.meanair.jan.ba.nosnowprec$gam)
AIC(model.meanair.jan.ba.nosnowprec$mer)
...
model.meanair.jan.co.all <- gamm4(air_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)
...
model.meanair.jan.co.nosnow <- gamm4(air_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)

summary(model.meanair.jan.co.nosnow$gam)
AIC(model.meanair.jan.co.nosnow$mer)

# Prev_av_prec is not significant (0.1). Let's remove it:

model.meanair.jan.co.nosnowprec <- gamm4(air_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + prev_av_temp, random = ~ (1|site:Plot), data = tree.temp.a.jan)

summary(model.meanair.jan.co.nosnowprec$gam)
AIC(model.meanair.jan.co.nosnowprec$mer)
...
```{r}
# basal area
model.maxair.jan.ba.all <- gamm4(max_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)
...
# canopy openness
model.maxair.jan.co.all <- gamm4(max_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + snow + prev_av_temp + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jan)
...
# Prev_av_temp is not significant (0.1). Let's remove it.

model.maxair.jul.ba.noprevtemp <- gamm4(max_off ~ s(Basal_Area_20m,perc_broad_20m) + s(Day) + site + wind + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jul)

summary(model.maxair.jul.ba.noprevtemp$gam)
AIC(model.maxair.jul.ba.noprevtemp$mer)


plot(model.maxair.jul.ba.noprevtemp$gam, scheme = 2, lwd = 3, main = "Max air temp offset warmest month", xlab = "Basal area", ylab = "Broadleaved component (%)", cex.lab = 1.5, labcex = 1.1, cex.main = 2, too.far = 0.2, rug=T, hcolor=colfunc(999), select = 1)
...
model.maxair.jul.co.noprevtemp <- gamm4(max_off ~ s(CanOpen,perc_broad_20m) + s(Day) + site + wind + prev_av_prec, random = ~ (1|site:Plot), data = tree.temp.a.jul)

summary(model.maxair.jul.co.noprevtemp$gam)
AIC(model.maxair.jul.co.noprevtemp$mer)


plot(model.maxair.jul.co.noprevtemp$gam, scheme = 2, lwd = 3, main = "Max air temp offset warmest month", xlab = "Canopy openness", ylab = "Broadleaved component (%)", cex.lab = 1.5, labcex = 1.1, cex.main = 2, too.far = 0.2, rug=T, hcolor=colfunc(999), select = 1)
