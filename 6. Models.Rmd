...
GAMM_r2aic <- function(model){
  ...
  forest.density <- if(grepl("CanOpen", formula) == TRUE){
    "Canopy openness"} else {expression(paste("Basal Area (", m^2, " \U00B7 ", ha^-1,")"))}
...
results.ba <- all.results[which(all.results$forest.density == expression(paste("Basal Area (", m^2, " \U00B7 ", ha^-1,")"))),]
